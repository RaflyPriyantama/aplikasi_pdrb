...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate("|#countdown 3||Jujur||Aku Ga Pintar||Merangkai Kata||Tapi||Aku Mau Jujur||Soal||Perasaan Aku||Ke Kamu||Aku||Suka Sama Kamu||Rahayu Puspita Sari||Dengan Perasaan||Yang Tulus||Maukah Kamu||Jadi Pacar Aku?||#rectangle|");
    }
